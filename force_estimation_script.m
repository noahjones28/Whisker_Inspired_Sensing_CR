...
function [Fx_estimate, MB_estimate, MD_estimate, F_estimate, s_estimate, z_estimate] = force_estimation_script(n, x, y, z, E, I, G, J, Fx, MB, MD, plot_graph) 
    ...
    F_estimate = optimized_params(1);
    s_estimate = optimized_params(2);
    z_estimate = optimized_params(3);
    
    % Check solution
    % Elastica 3D
    [x3,y3,z3, F] = elastica3D(x,y,z,{[F_estimate,s_estimate,z_estimate]},'mode','force', 'plot_steps', false, 'plot', false, 'E', E, 'I', I, 'G', G, 'J', J);
