...
function [Fx_sim, MB_sim, MD_sim, Fx_estimate, MB_estimate, MD_estimate, F_estimate, s_estimate, z_estimate] = force_estimation_from_simulation(n, x, y, z, F_applied, s_applied, z_applied, E, I, G, J)
    %% Elastica 3D Config
    ...
    global plot_graph
    plot_graph = false;
    global display % print stuff to command window
    display = false;
    if plot_graph == false
    ...
    [Fx_estimate, MB_estimate, MD_estimate, F_estimate, s_estimate, z_estimate] = force_estimation_script(n, x, y, z, E, I, G, J, Fx_model, MB_model, MD_model);
end